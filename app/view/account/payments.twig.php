...
<div class="main-container container">
    ...
    <form action="{{BASE}}account/deposit-money" method="post">
        <div class="col-12 text-center mb-4">
            <input type="text" class="trasparent-input text-center" name="saldo" value="0" placeholder="Digite o total a depositar">
                        ...
                        <div class="card {{card.fundo}}">
                            <div class="card-body">
                                <div class="form-check position-absolute end-0 bottom-0 m-1">
                                    <input class="form-check-input rounded-circle" value="{{card.conta}}" name="numero" type="radio" id="card1">
